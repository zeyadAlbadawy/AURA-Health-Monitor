...
async def handle_vitals(sid, data):
    ...
    if alert_payload:
        ...
        # --- NEW: Added steps and gps to print statement ---
        print(f"status: {status} | hr: {heart_rate} (danger for: {duration}s) | spo2: {sp02}% | steps: {steps} | loc: {gps}")
